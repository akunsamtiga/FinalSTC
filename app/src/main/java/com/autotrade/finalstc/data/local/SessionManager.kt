...
class SessionManager @Inject constructor(
    ...
    companion object {
        ...
        private const val KEY_CURRENCY_ISO = "currency_iso"  // Key baru untuk ISO
    ...
    fun saveUserSession(userSession: UserSession) {
        sharedPreferences.edit().apply {
            ...
            putString(KEY_CURRENCY_ISO, userSession.currencyIso)  // Simpan ISO
    ...
    // Method baru untuk menyimpan ISO
    ...
    // Method baru untuk mengambil ISO
    fun getCurrencyIso(): String {
        return sharedPreferences.getString(KEY_CURRENCY_ISO, "IDR") ?: "IDR"
    }

    // Method baru untuk menyimpan currency dan ISO sekaligus
    ...
    // Tambahkan fungsi load scheduled orders
    ...
    // Tambahkan fungsi clear scheduled orders
